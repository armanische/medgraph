        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {categories.map((category, index) => (
            ...
            >
              ...
              <h3 className="mt-3 text-[13px] font-bold leading-5 tracking-[-0.01em]">{category.name}</h3>
              <p className="mt-2 max-w-[16rem] text-[11px] leading-5 text-cm-slate">{category.shortDescription}</p>
              <div className="mt-3 font-mono text-[9px] text-cm-dim">
