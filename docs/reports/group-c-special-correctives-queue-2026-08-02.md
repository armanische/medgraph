# Group C Special Correctives Queue — 2026-08-02

| Product | Source UID | Required corrective | Durable state | Блокирует запуск |
| --- | --- | --- | --- | --- |
| AOHUA VME-5B | `275089738610` | Remove/replace SupFire media through a controlled media boundary | Draft, `0/0/0/0` | Нет |
| Pentax EPK-i7010 | `529970599662` | Replace EPK-i7000 assets with approved exact-model media | Draft, `0/0/0/0` | Нет |
| Гемос-ПФ | `576228046022` | Correct swapped base type characteristic | Draft, `0/0/0/0` | Нет |
